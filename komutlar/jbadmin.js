...
user.addRole('487316934036160522').then(user.addRole('487316186367787018')).then(user.addRole('699984672758956112'));
  
   const embed = new Discord.RichEmbed()
        .setDescription(`${user} kullanıcısına başarıyla JB Admin rolü verildi!`)
