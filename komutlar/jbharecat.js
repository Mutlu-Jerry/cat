...
user.addRole('487316791933140992').then(user.addRole('696050676849049692')).then(user.addRole('699984672758956112'));
  
   const embed = new Discord.RichEmbed()
        .setDescription(`${user} kullanıcısına başarıyla Cat Harekat rolü verildi!`)
